...
export interface UserServiceClient {
  ...
  ): Observable<FindByIdForAuthResponse>;

  findByIdsForMention(
    request: FindByIdsForMentionRequest,
  ): Observable<FindByIdsForMentionResponse>;
...
export interface UserServiceController {
  findByIdForAuth(
    ...
    | Promise<FindByIdForAuthResponse>
    | Observable<FindByIdForAuthResponse>
    | FindByIdForAuthResponse;

  findByIdsForMention(
    request: FindByIdsForMentionRequest,
  ):
    | Promise<FindByIdsForMentionResponse>
    | Observable<FindByIdsForMentionResponse>
    | FindByIdsForMentionResponse;
