    ...
    <>
      ...
      <ul className="dark:text-dark-text">
        ...
        {user && user.isPremium == true ? (
          ...
          <>
            <Link href="/premium">
              <li className="text-xl font-semibold my-1 cursor-pointer hover:bg-gray-100 p-1 hover:text-pink">
                <i className="fas fa-gem"></i> <span>Tắt quảng cáo</span>{' '}
              </li>
            </Link>
          </>
        )}
      ...
      <ul className="dark:text-dark-text">
        <a
          target="_blank"
          rel="noreferrer"
          href="https://www.facebook.com/yurineko.shop/posts/pfbid02RwqSNCYfv6znYCfMzWxuBGuTkAYtMZbvGC3DfKamt7eeS8LgfwZAmCaqVxF7WviDl"
        >
          <li className="text-xl font-semibold my-1 cursor-pointer hover:bg-gray-100 p-1 hover:text-pink">
            <i className="fas fa-shopping-cart"></i> <span>Yurineko Shop</span>
          </li>
        </a>
        <a target="_blank" rel="noreferrer" href="https://www.facebook.com/yurineko.moe">
          <li className="text-xl font-semibold my-1 cursor-pointer hover:bg-gray-100 p-1 hover:text-pink">
        ...
        <a target="_blank" rel="noreferrer" href="/quy-dinh">
          <li className="text-xl font-semibold my-1 cursor-pointer hover:bg-gray-100 p-1 hover:text-pink flex items-center">
            <ProfileOutlined className="mr-2 text-xl" /> <span>Quy định</span>
          </li>
        </a>
        {user ? (
          <li
