...
const menu = [
  ...
  },
  {
    ...
    button: (
      <button className="h-10 border-2 border-button-done rounded bg-button-done text-md text-white px-2 py-2 flex items-center justify-center">
  ...
  },
  {
    ...
    button: (
      <button className="h-10 border-2 border-button-will rounded bg-button-will text-md text-white px-2 py-2 flex items-center justify-center">
  ...
  },
  {
    ...
    button: (
      <button className="h-10 border-2 border-button-stop rounded bg-button-stop text-md text-white px-2 py-2 flex items-center justify-center">
...
export default function ListSelectInChapterShort({ mangaId, defaultListKey }) {
