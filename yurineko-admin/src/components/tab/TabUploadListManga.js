...
import { getMangaList, delManga } from "../../redux/actions/upload";
...
import DataField from "../table/UploadManga";
...
function TabUploadListManga({ ...props }) {
...
export default connect(mapStateToProps, mapDispatchToProps)(TabUploadListManga);
