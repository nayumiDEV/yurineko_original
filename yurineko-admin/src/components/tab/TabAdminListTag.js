...
import { getTagList, delData, addData, editData } from "../../redux/actions";
...
import DataField from "../table/AdminTag";
...
function TabAdminListManga({ ...props }) {
  ...
  const handleDelete = (id) => {
    props.delData({ type: "tag", id }, getData);
  };

  const handleAdd = (data) => {
    props.addData({ type: "tag", data }, getData);
  };

  const handleEdit = (data) => {
    let newData = { ...editData, ...data };
    props.editData({ type: "tag", data: newData }, getData);
    handleCloseDrawer();
  };
  ...
  return (
    <>
      ...
      >
        <AddTag onCancel={handleCancel} handleOk={handleOk} />
      </Modal>
