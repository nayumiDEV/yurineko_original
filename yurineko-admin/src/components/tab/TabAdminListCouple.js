...
import { getCoupleList, delData, addData, editData } from "../../redux/actions";
...
import DataField from "../table/AdminCouple";
import AddCouple from "../form/AddCouple";
...
function TabAdminListManga({ ...props }) {
  ...
  const handleDelete = (id) => {
    props.delData({ type: "couple", id }, getData);
  };

  const handleAdd = (data) => {
    props.addData({ type: "couple", data }, getData);
  };

  const handleEdit = (data) => {
    let newData = { ...editData, ...data };
    props.editData({ type: "couple", data: newData }, getData);
    handleCloseDrawer();
  };
  ...
  return (
    <>
      ...
      >
        <AddCouple onCancel={handleCancel} handleOk={handleOk} />
      </Modal>
