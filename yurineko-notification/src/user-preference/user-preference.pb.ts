...
export interface UserPreferenceServiceClient {
  ...
  ): Observable<InitUserPreferenceResponse>;
  ...
  ): Observable<SetUserPreferenceResponse>;
}
...
export interface UserPreferenceServiceController {
  initUserPreference(
    ...
    | Promise<InitUserPreferenceResponse>
    | Observable<InitUserPreferenceResponse>
    | InitUserPreferenceResponse;
  ...
  setUserPreference(
    ...
    | Promise<SetUserPreferenceResponse>
    | Observable<SetUserPreferenceResponse>
...
export function UserPreferenceServiceControllerMethods() {
  return function (constructor: Function) {
    ...
    for (const method of grpcMethods) {
      ...
      GrpcMethod('UserPreferenceService', method)(
    ...
    for (const method of grpcStreamMethods) {
      ...
      GrpcStreamMethod('UserPreferenceService', method)(
        constructor.prototype[method],
        method,
        descriptor,
      );
